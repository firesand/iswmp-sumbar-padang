    ...
    <div class="bg-white rounded-lg p-6 max-w-md mx-4">
      <div class="text-center">
        ...
        <p class="text-gray-600 mb-4">
          Aplikasi memerlukan akses lokasi GPS untuk memvalidasi kehadiran Anda.
          Tanpa izin lokasi, absensi tidak dapat diproses.
        </p>
        <div class="space-y-3">
          ...
          <button id="skip-location" class="w-full bg-gray-200 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-300 transition-colors">
            Batal
          </button>
        </div>
      </div>
